...
methods {
    ...
    function _.rayMul(uint256 a, uint256 b) internal => rayMulPreciseSummariztion(a, b) expect uint256 ALL;
    function _.rayDiv(uint256 a, uint256 b) internal => rayDivPreciseSummariztion(a, b) expect uint256 ALL;
}
...
rule depositUpdatesUserATokenBalance2(env e) {
    ...
    assert false; // To read what the interest rates should be
